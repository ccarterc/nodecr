...
Tesseract = (function() {
  ...
  */
  ...
  Tesseract.prototype.process = function(image, callback, languageCode, pageSegMode, config, preprocessor, preprocessOptions) {
    var _this = this;
  ...
  */
  ...
  Tesseract.prototype.preprocessor = function(inputFile, callback, preprocessOptions) {
  ...
  Tesseract.prototype.preprocessors = {
    convert: ConvertPreprocessor = function(inputFile, callback, preprocessOptions) {
      ...
      tmp.tmpName({
        ...
        //handle resize param
        command.push('-resize');
        if(preprocessOptions && preprocessOptions.resize){
          command.push(preprocessOptions.resize);
        }else{
          command.push(defaultOptions.resize);
        }

        //handle sharpen param
        command.push('-sharpen');
        if(preprocessOptions && preprocessOptions.sharpen){
          command.push(preprocessOptions.sharpen);
        }else{
          command.push(defaultOptions.sharpen);
        }
